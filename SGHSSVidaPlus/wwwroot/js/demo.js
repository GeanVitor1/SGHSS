...
function showOverlay(targetId) {
	...
	$targetDiv.append(overlayHTML);

	$targetDiv.find('.overlaySpinner').css('visibility', 'visible');
}

function hideOverlay(targetId) {
	$(targetId).find('.overlaySpinner').remove();
}
...
//Notify
const mensagem = {
    show: function (titulo, mensagem, tempo, tipo) {
        let type = "primary";
        let icon = "bell";
    ...
    error: function (titulo, mensagem, tempo) {
        this.show(titulo, mensagem, tempo, "error");
    },

    success: function (titulo, mensagem, tempo) {
        this.show(titulo, mensagem, tempo, "success");
    },

    info: function (titulo, mensagem, tempo) {
        this.show(titulo, mensagem, tempo, "info");
    },
    warning: function (titulo, mensagem, tempo) {
        this.show(titulo, mensagem, tempo, "warning");
    }
};
