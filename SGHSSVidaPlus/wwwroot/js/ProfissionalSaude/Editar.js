...
function novaFormacaoAcademica() {
    var profissionalSaudeId = $("#profissionalSaudeId").val(); // Pega o ID do profissional
    $.get("/ProfissionalSaude/TelaNovaFormacaoAcademica?profissionalSaudeId=" + profissionalSaudeId, function (data) {
...
function gravarEdicao() {
    ...
    if (form[0].checkValidity()) {
        ...
        $.ajax({
            url: "/ProfissionalSaude/Editar", // URL do controlador ProfissionaisSaude, método Editar (POST)
            method: "POST",
            data: formData,
